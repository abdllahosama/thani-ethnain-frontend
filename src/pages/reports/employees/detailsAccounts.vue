  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <indexHeader
          :title="'التقارير'"
          :description="'تفاصيل حساب الموظف.'"
        />
        <div class="card">
...
export default {
  data() {
    return {
      path: "/reports/employees/detailsAccounts",
      items: [],
      ...
      excel: {
        fileName: 'employees detail account',
        reportData: '[]'
      },
