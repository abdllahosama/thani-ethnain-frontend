<template>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <indexHeader :title="'التقارير'" :description="'ضريبة البيع حسب العميل.'"/>
                <div class="card">
                ...
                <div class="card" id="reportShow">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-nowrap  table-hover">
                            <thead>
                                <tr>
                                    <tableTh :text="'العميل'"></tableTh>
                                    <tableTh :text="'رقم التعريف الضريبي'"></tableTh>
                                    <tableTh :text="'رقم الفاتورة'"></tableTh>
                                    <tableTh :text="'المجموع'"></tableTh>
                                    <tableTh :text="'الضريبة'"></tableTh>
                                    <tableTh :text="'مجموع المبلغ'"></tableTh>
                                </tr>
                            </thead>
                            ...
                            <tbody class="list" v-for="(item, index) in items" :key="index">
                                <tr>
                                    <tableTd :text="item.name"></tableTd>
                                    <tableTd :text="item.tax_number"></tableTd>
                                    <td></td>
                                ...
                                <tr v-for="(invoce, index) in item.invoices" :key="index">
                                    <td></td>
                                    <td></td>
                                    <tableTd :text="invoce.code"></tableTd>
                                    <tableTd :text="invoce.subtotal" :after="$option.currency"></tableTd>
                                    <tableTd :text="invoce.tax" :after="$option.currency"></tableTd>
                                    <tableTd :text="invoce.total" :after="$option.currency"></tableTd>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
...
<script>
    ...
    export default {
        data() {
            return {
                path: '/reports/taxes/saleVatByClients',
                items: [],
