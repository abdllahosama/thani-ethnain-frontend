<template>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <indexHeader :title="'التقارير'" :description="'ضريبة المخرجات.'"/>
                <div class="card">
                        ...
                        <table class="table table-sm table-nowrap  table-hover">
                            ...
                            <tbody class="list">
                                ...
                                <tr v-for="(item, index) in items" :key="index">
                                    <tableTd :text="item.customer.name"></tableTd>
                                    <tableTd :text="item.customer.tax_number"></tableTd>
...
<script>
    ...
    export default {
        data() {
            return {
                path: '/reports/taxes/saleVatLiability',
                items: [],
