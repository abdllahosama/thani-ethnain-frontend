<template>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <indexHeader :title="'التقارير'" :description="'ملخص ضريبة المشتريات.'"/>
                <div class="card">
                ...
                <div class="card" id="reportShow">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-nowrap table-hover">
                            <thead>
                                <tr>
                                    <tableTh :text="'اسم معدل الضريبة'"></tableTh>
                                    <tableTh :text="'نسبة معدل الضريبة'"></tableTh>
                                    <tableTh :text="'المبلغ'"></tableTh>
                                    <tableTh :text="'مبلغ الضريبة'"></tableTh>
                                </tr>
                            </thead>
                            ...
                            <tbody class="list">
                                ...
                                <tr v-for="(item, index) in items" :key="index">
                                    ...
                                    <tableTd :text="item.rate" :after="'%'"></tableTd>
                                    <tableTd :text="item.subtotal" :after="$option.currency"></tableTd>
                                    <tableTd :text="item.average" :after="$option.currency"></tableTd>
                                </tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th><strong>{{average}} {{$option.currency}}</strong></th>
                                </tr>
                            </tfoot>
                        </table>
...
<script>
    ...
    export default {
        data() {
            return {
                path: '/reports/taxes/expenseTaxSummary',
                items: [],
                    ...
                    .then(response => {
                        ...
                        this.items.forEach(item => {
                            ...
                            item.invoiceItems.forEach(invoiceItem => {
                                item.subtotal += invoiceItem.subtotal;
                                item.average += invoiceItem.average;
