<template>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <indexHeader :title="'التقارير'" :description="'ضريبة الشراء حسب المورد.'"/>
                <div class="card">
                        ...
                        <table class="table table-sm table-nowrap  table-hover">
                            ...
                            <tbody class="list" v-for="(item, index) in items" :key="index">
                                ...
                                <tr v-for="(bill, index) in item.bills" :key="index">
                                    <td></td>
                                    <td></td>
                                    <tableTd :text="bill.code"></tableTd>
                                    <tableTd :text="bill.subtotal" :after="$option.currency"></tableTd>
                                    <tableTd :text="bill.tax" :after="$option.currency"></tableTd>
                                    <tableTd :text="bill.total" :after="$option.currency"></tableTd>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
...
<script>
    ...
    export default {
        data() {
            return {
                path: '/reports/taxes/purchaseVatBySuppliers',
                items: [],
