                ...
                <div class="card card-body p-5 invoice-show">
                    <div class="row">
                        ...
                        <div class="col-4 text-md-right">
                            ...
                            <p class="mb-2">
                                <time datetime="2018-04-23">{{item.expiry_date}}</time>
                            </p>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <tbody>
                                        <tr v-for="qItem in item.quotationItems" :key="qItem.id">
                                            ...
                                            <td class="px-0" v-if="item.discount != 0">
                                                -{{qItem.discount}} {{$option.currency}}
                                            </td>
                                            <td class="px-0" v-if="item.tax != 0">
                                                {{qItem.average}} {{$option.currency}}
                                            </td>
                                            <td class="px-0 ">
                                        ...
                                        <tr>
                                            ...
                                            <td  colspan="6" class="px-0 border-top border-top-2">
                                                <span class="h3">
                                                    {{item.subtotal + item.discount}} {{$option.currency}}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr v-if="item.edit">
                                        ...
                                        <template  v-if="$option.show_old_balance">
                                          <tr>
                                              ...
                                              <td colspan="6"  class="px-0 border-top border-top-2">
                                                  <span class="h3">
                                                      {{item.old_balance}} {{$option.currency}}
                                                  </span>
                                              </td>
                                          </tr>
                                          <tr>
                                              ...
                                              <td colspan="6" class="px-0 border-top border-top-2">
                                                  <span class="h3">
                                                      {{item.new_balance}} {{$option.currency}}
                                                  </span>
                                              </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                              ...
                                              <td colspan="6" class="px-0 border-top border-top-2">
                                                  <span class="h3">
                                                      {{item.salesPayment ? item.salesPayment.new_balance : item.new_balance}} {{$option.currency}}
                                                  </span>
                                              </td>
                                          </tr>
                                        </template>
