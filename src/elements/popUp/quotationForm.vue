                ...
                <div class="modal-card card">
                    <div class="card-header">
                        <h4 class="card-header-title">
                            {{$t('quotations.form.addQuotation')}}
                        </h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-sm-12">
                                        {{$t('quotations.form.quotationDate')}}
                                    </label>
                                    <div class="icon-input col-md-12">
                                        <span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-sm-12">
                                        {{$t('quotations.form.quotationGroup')}}
                                    </label>
                                    <div class="icon-input col-md-12">
                                        <span>
                                        ...
                                        <select  class="form-control" v-model="quotation.invoice_group" :class="{ 'is-invalid' : errors.invoice_group}" @change="errors.invoice_group = false"> 
                                            <option value="">{{$t('quotations.form.selectGroup')}}</option>
    ...
    export default {
        ...
        methods: {
            ...
            createَQuotation() {
                ...
                if (error == 0) {
                    axios.post(this.$linkGnirator('/quotations'), this.quotation)
                        .then(response => {
                            this.$parent.add = 0;
                            this.$parent.$parent.model = 0;
                            this.$parent.$parent.aletText = this.$t('allerts.quotationSuccessfullyAdde');
                            this.$parent.$parent.alertType = "success";
                            this.$router.push('/quotations/' + response.data + '/edit');
                        });
                }
            },
            colse() {
                this.$parent.quotationForm = false;
            },
